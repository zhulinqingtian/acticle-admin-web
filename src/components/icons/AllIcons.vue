<template>
  <div>
    ...
    <ul class="icon-list">
      ...
      <li><span><i class="el-icon-delete-solid"></i><span class="icon-name">el-icon-delete-solid</span></span></li>
      ...
      <li><span><i class="el-icon-warning-outline"></i><span class="icon-name">el-icon-warning-outline</span></span>
      </li>
      ...
      <li><span><i class="el-icon-camera-solid"></i><span class="icon-name">el-icon-camera-solid</span></span></li>
      ...
      <li><span><i class="el-icon-video-camera"></i><span class="icon-name">el-icon-video-camera</span></span></li>
      <li><span><i class="el-icon-message-solid"></i><span class="icon-name">el-icon-message-solid</span></span></li>
      <li><span><i class="el-icon-bell"></i><span class="icon-name">el-icon-bell</span></span></li>
      <li><span><i class="el-icon-s-cooperation"></i><span class="icon-name">el-icon-s-cooperation</span></span></li>
      ...
      <li><span><i class="el-icon-s-management"></i><span class="icon-name">el-icon-s-management</span></span></li>
      ...
      <li><span><i class="el-icon-s-opportunity"></i><span class="icon-name">el-icon-s-opportunity</span></span></li>
      ...
      <li><span><i class="el-icon-bottom-right"></i><span class="icon-name">el-icon-bottom-right</span></span></li>
      ...
      <li><span><i class="el-icon-refresh-right"></i><span class="icon-name">el-icon-refresh-right</span></span></li>
      <li><span><i class="el-icon-refresh-left"></i><span class="icon-name">el-icon-refresh-left</span></span></li>
      ...
      <li><span><i class="el-icon-folder-opened"></i><span class="icon-name">el-icon-folder-opened</span></span></li>
      <li><span><i class="el-icon-folder-add"></i><span class="icon-name">el-icon-folder-add</span></span></li>
      <li><span><i class="el-icon-folder-remove"></i><span class="icon-name">el-icon-folder-remove</span></span></li>
      <li><span><i class="el-icon-folder-delete"></i><span class="icon-name">el-icon-folder-delete</span></span></li>
      <li><span><i class="el-icon-folder-checked"></i><span class="icon-name">el-icon-folder-checked</span></span></li>
      <li><span><i class="el-icon-tickets"></i><span class="icon-name">el-icon-tickets</span></span></li>
      <li><span><i class="el-icon-document-remove"></i><span class="icon-name">el-icon-document-remove</span></span>
      </li>
      <li><span><i class="el-icon-document-delete"></i><span class="icon-name">el-icon-document-delete</span></span>
      </li>
      <li><span><i class="el-icon-document-copy"></i><span class="icon-name">el-icon-document-copy</span></span></li>
      <li><span><i class="el-icon-document-checked"></i><span class="icon-name">el-icon-document-checked</span></span>
      </li>
      <li><span><i class="el-icon-document"></i><span class="icon-name">el-icon-document</span></span></li>
      <li><span><i class="el-icon-document-add"></i><span class="icon-name">el-icon-document-add</span></span></li>
      ...
      <li><span><i class="el-icon-takeaway-box"></i><span class="icon-name">el-icon-takeaway-box</span></span></li>
      ...
      <li><span><i class="el-icon-data-analysis"></i><span class="icon-name">el-icon-data-analysis</span></span></li>
      <li><span><i class="el-icon-collection-tag"></i><span class="icon-name">el-icon-collection-tag</span></span></li>
      ...
      <li><span><i class="el-icon-toilet-paper"></i><span class="icon-name">el-icon-toilet-paper</span></span></li>
      <li><span><i class="el-icon-office-building"></i><span class="icon-name">el-icon-office-building</span></span>
      </li>
      ...
      <li><span><i class="el-icon-shopping-cart-1"></i><span class="icon-name">el-icon-shopping-cart-1</span></span>
      </li>
      <li><span><i class="el-icon-shopping-cart-2"></i><span class="icon-name">el-icon-shopping-cart-2</span></span>
      </li>
      <li><span><i class="el-icon-shopping-bag-1"></i><span class="icon-name">el-icon-shopping-bag-1</span></span></li>
      <li><span><i class="el-icon-shopping-bag-2"></i><span class="icon-name">el-icon-shopping-bag-2</span></span></li>
      ...
      <li><span><i class="el-icon-chat-line-round"></i><span class="icon-name">el-icon-chat-line-round</span></span>
      </li>
      <li><span><i class="el-icon-chat-square"></i><span class="icon-name">el-icon-chat-square</span></span></li>
      <li><span><i class="el-icon-chat-dot-round"></i><span class="icon-name">el-icon-chat-dot-round</span></span></li>
      <li><span><i class="el-icon-chat-dot-square"></i><span class="icon-name">el-icon-chat-dot-square</span></span>
      </li>
      <li><span><i class="el-icon-chat-line-square"></i><span class="icon-name">el-icon-chat-line-square</span></span>
      </li>
      ...
      <li><span><i class="el-icon-switch-button"></i><span class="icon-name">el-icon-switch-button</span></span></li>
      <li><span><i class="el-icon-full-screen"></i><span class="icon-name">el-icon-full-screen</span></span></li>
      <li><span><i class="el-icon-copy-document"></i><span class="icon-name">el-icon-copy-document</span></span></li>
      ...
      <li><span><i class="el-icon-first-aid-kit"></i><span class="icon-name">el-icon-first-aid-kit</span></span></li>
      ...
      <li><span><i class="el-icon-location-information"></i><span class="icon-name">el-icon-location-information</span></span>
      </li>
      <li><span><i class="el-icon-add-location"></i><span class="icon-name">el-icon-add-location</span></span></li>
      <li><span><i class="el-icon-delete-location"></i><span class="icon-name">el-icon-delete-location</span></span>
      </li>
      <li><span><i class="el-icon-map-location"></i><span class="icon-name">el-icon-map-location</span></span></li>
      ...
      <li><span><i class="el-icon-partly-cloudy"></i><span class="icon-name">el-icon-partly-cloudy</span></span></li>
      <li><span><i class="el-icon-cloudy-and-sunny"></i><span class="icon-name">el-icon-cloudy-and-sunny</span></span>
      </li>
      ...
      <li><span><i class="el-icon-goblet-square"></i><span class="icon-name">el-icon-goblet-square</span></span></li>
      <li><span><i class="el-icon-goblet-square-full"></i><span
        class="icon-name">el-icon-goblet-square-full</span></span></li>
      <li><span><i class="el-icon-refrigerator"></i><span class="icon-name">el-icon-refrigerator</span></span></li>
      ...
      <li><span><i class="el-icon-potato-strips"></i><span class="icon-name">el-icon-potato-strips</span></span></li>
      <li><span><i class="el-icon-lollipop"></i><span class="icon-name">el-icon-lollipop</span></span></li>
      <li><span><i class="el-icon-ice-cream-square"></i><span class="icon-name">el-icon-ice-cream-square</span></span>
      </li>
